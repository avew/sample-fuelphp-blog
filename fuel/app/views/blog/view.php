...
<p><strong>Posted:</strong> <?php echo date('nS F, Y', $post->created_at); ?> (<?php echo Date::time_ago($post->created_at) ?>)
...
<div class="row">
    <div class="input"><?php echo Form::submit('submit','Submit Comment'); ?></div>
</div>
